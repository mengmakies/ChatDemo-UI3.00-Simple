...
//    self.answerButton.enabled = NO;
    [[ChatUIHelper shareHelper] answerCall:_callSession.callId];
#endif
}
...
- (void)hangupAction
{
    ...
    [[ChatUIHelper shareHelper] hangupCallWithReason:EMCallEndReasonHangup];
#endif
}
...
- (void)rejectAction
{
    ...
    [[ChatUIHelper shareHelper] hangupCallWithReason:EMCallEndReasonDecline];
#endif
}
